...
### Controls
- Pressing `FX-L` (left) will close the current open folder. 
- Holding `FX-L/R` and scrolling will scroll through the sorting you have. 
...
## Matching
After selecting a song, you will go into matching.

...
<div className="flex items-center justify-center">
  <img src='/copendium/radar/radar.png' width="400"/>
</div>

Each chart has it's own radar, as shown in the image above. Radar is made up of
...
that skill is prevelant in the chart.
...
### Tsunami
This represents lasers. The more lasers, the higher this will be on the rader.
For mainly laser charts, you can tell by the Tsunami section in the rader being
super lopsided.
...
### Hand Trip
How many notes that need to be hit on the other side of the controller. For
example, cross handing a laser, hitting BT-A or BT-B with your right hand,
hitting BT-C or BT-D with your left hand. 

### Tricky
Catch all for anything else not mention. This is generally speed changes, jacks,
spins, gimmicks, etc.

## Profile radar
There is also a profile radar, only viewable when you card in and look at your
profile, and at the end of credit screen. This is it's own seperate system
similar to VF. It takes your best 50 of each category and measures that.

Note that this system and the equation it uses is not well known. The main
thing that is known about it is that it uses ex-score and not normal score.

In general, most people don't care for this.
...
<center>
  <img src='/copendium/unlocks/blastergauge.png' width="400"/>
</center>
...
### Stamp
This is usually the most common event. Each song has a certian amount of stamps
you need to obtain. You gain stamps at the end of your credit. You get 1 stamp
for standard start, and 2 stamps for anything else. (This sometimes changes, but
usually any thing that cost more money to play will give you 2 stamps).
...
Currently, this event is currently going on with no end date. This event is a

...
## Clears
    ...
    This is a clear with the gauge that starts at 0% and you have to be over 70% gauge. Read more about Effective Gauge on the [Gauge Options](/compendium/gauge-options#effective-rate) page.
...
## General Terms
    ...
    ##### NOV, ADV, EXH, MXM
    These are the four standard difficulties. NOV, or novice, is the easiest, while MXM, or maximum, is generally the hardest standard difficulty. Every song has NOV, ADV, and EXH charts, while new songs usually have an MXM chart.

    ##### INF, GRV, HVN, VVD, XCD, NBL
    These are additional fourth-chart difficulties usually added to older songs in later versions. They are attached to the version that introduced them; for example, a chart with an additional difficulty introduced in SOUND VOLTEX VIVID WAVE would have a VVD difficulty.

    ##### ULT
    ULT, or ultimate, is a special fifth difficulty introduced in SOUND VOLTEX EXCEED GEAR. It is separate from the standard difficulty progression and the version-specific fourth-chart difficulties above. Currently, Everlasting Message is the only song with an ULT chart.
    ...
    The subtitles used by SOUND VOLTEX versions so far are:
    ...
    The latest arcade version of SDVX is Nabla; older cabinets that are still in operation generally remain on Exceed Gear. Meanwhile, Konasute still uses Exceed Gear as its subtitle, and its core game mechanics also remain based on Exceed Gear. Although Konasute has already added songs that debuted in arcade Nabla, its charts at level 17 and above do not use decimal level notation.
    ...
    #### PCB/BLC/PC [#pcb-blc-pc]
    PCB was the in-game currency used in Exceed Gear. Nabla split PCB into BLC and PC: BLC is used to unlock songs through Track Input, while PC is used for the Appeal Parts Generator. BLC is mainly earned through playing and matching, while PC is mainly earned through achievements and stamp events. For details, see [Unlock Systems](/compendium/unlock-systems#blc) and [Customization](/compendium/customization).
...
## Techniques
    ...
    <Image src="/terminology/terminology/vertical_reading.webp" caption="WHITEOUT MXM 20 Measure 16"/>
    ...
    <Image src="/terminology/terminology/horizontal_reading.webp" caption="Blastix Riotz EXH 18 Measure 116"/>
    ...
    <Image src="/terminology/terminology/ghost_tapping1.webp" className="w-64 h-auto" caption="A Lasting Promise MXM 19 Measure 118"/>
...
## Music Theory
    ...
    Note that a 32nd note stream on a 100 BPM song is the same speed as a 16th note stream on a 200 BPM song. The faster the BPM, the faster the speed.

...
## General Terms
    ...
    ##### NOV, ADV, EXH, MXM
    These are the four standard difficulties. NOV, or novice, is the easiest, while MXM, or maximum, is generally the hardest standard difficulty.

    ##### INF, GRV, HVN, VVD, XCD, NBL
    These are additional fourth-chart difficulties introduced in later versions. They are attached to the version that introduced them; for example, a chart with an additional difficulty introduced in SOUND VOLTEX VIVID WAVE would have a VVD difficulty.

    ##### ULT
    ULT, or ultimate, is a special fifth difficulty introduced in SOUND VOLTEX EXCEED GEAR. It is separate from the standard difficulty progression and the version-specific fourth-chart difficulties above.

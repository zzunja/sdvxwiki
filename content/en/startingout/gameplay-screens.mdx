...
## Song Select
When starting the game, you will be brought to song selection. Song selection is where you select the chart you would like to play. Keep an eye on the song selection countdown!
...
### Search [#song-select-search]
On Valkyrie cabinets, the secondary screen is a touchscreen that you can use to search for songs (Konasute also has a secondary screen, but it is generally operated with a mouse). The search function opens an on-screen keyboard for entering text. Note that you may need some knowledge of Japanese to enter song titles.
...
<Image src="/startingout/gameplay-screens/Sort.webp" className="w-100"/>
...
- **VOLFORCE POTENTIAL** See more [here](/compendium/volforce#volforce-potential-folder)
...
### Tips for moving around folders
If you want to access a song in Blaster Gate or Omega Dimension but don't want to go through the whole song you can
- Hover over the locked song
- Close the folder with `FX-L`
- Go to the Blaster Gate or Omega Dimension folder and open it

You will be put onto the songs you had hovered

If you want to go to the top of a level folder quickly
- Switch to a different difficulty on what song you are hovering
- Press `FX-L` twice to close and reopen the folder
...
You can adjust your lane speed by holding `START` and moving either knob, or change other game options here.
...
6. **Blaster gauge:** Shows you your current blaster gauge percentage or variant gauge percentage.

...
## Score
<Callout>
This page is talking about Normal Score. To see more on Ex-Score, see the [Ex-Score page.](/compendium/ex-score)
</Callout>
...
`9,800,000` to a `9,899,999` will give you much less volforce than going from
`9,899,999` to `9,990,000`. This is because the 989x-990x is going from AAA+ to
...
If you were playing a chart and didn't give up halfway, you shouldn't get
...
more difficult to get than a S.

When starting, you might not understand what a good score vs a bad score

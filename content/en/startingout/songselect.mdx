...
Here you can also select what difficulty you want to set the chart as. Change the difficulty with `VOL-L`. You can also see what gauge you are using as well as if you are using mirror, random, or S-RAN. Press start to being the chart.
...
<Image src="/startingout/songselect/Sort.png" className="w-100"/>
...
### Folders
<Image src="/startingout/songselect/folders.png"/>

Folders allow you to sort through songs easier.
- **x行** 
...
- **Search by Contest** will search charts by contest. These are KAC, BPL, and other contest they do
- **Search by Version** will search by each version of the game. Booth, Infinite Infection, Gravity Wars etc.
- **Released** will sort by release date. Top is oldest, bottom is newest.
- **SKILL LEVEL**
- **Favorites** will sort by your favorites. Can hold up to 50 songs.
- **VOLFORCE** will sort by what is in your best 50. This does not sort by what is giving you the highest VF, rather what sorting mode you are currently on.
- **EFFECT RADAR** will sort charts by what their highest part of the radar is. More information about radar on the [Radar page](/compendium/radar)
- **PLAYER RADAR** will sort by whats on your player radar.
...
You can also adjust your lane speed here with holding `START` and moving either knob. 

<Image src="/startingout/songselect/matching.png" className="w-100"/>
...
<Image src="/startingout/songselect/ingame.jpg" className="w-100"/>
...
<Image src="/startingout/songselect/title.png" className="h-60"/>
...
<Image src="/startingout/songselect/bpm-and-lanespeed.png" className="h-100"/>
...
<Image src="/startingout/songselect/player-profile.png" className="h-100"/>
- **Challenge and quick retry:** Only appears during premium time or on Konasute. Shows current challenge set. Pressing `00` on the numpad will enable auto quick retry, making it so that the moment you fail out, you will automatically
   retry.
<Image src="/startingout/songselect/challenge.png" className="h-100"/>
- **Current score, ex score, and highest chain you have had:** If you are using
   ex-score, this will look slightly different. See below for difference
<Image src="/startingout/songselect/scoredifference.png" />

To learn more about EX-Score, see [EX-Score page](/compendium/exscore)

- **Life Gauge:** This is your gauge. It might look different depending on what your
   settings. To learn more about gauge, see [Gauge Options](/compendium/gauge-options) page.
<Image src="/startingout/songselect/gauge.png" className="w-40"/>
...
<Image src="/startingout/songselect/scoreScreen.jpg" className="w-120"/>
...
1. **What the challenge was and how many quick retries you did:** Only counts quick
   ...
   <Image src="/startingout/songselect/quick-retry.png" className="w-80"/>
2. **Title, Score, compare to personal best, and ex score:** Shows your score compare to personal best and your ex-score. If you were using
   ex-score this would look slightly different. 
   <Image src="/startingout/songselect/clear-title.png" className="w-100"/>
3. **S-Crit, Crit, Near, and Error count:** Shows you how many S-Crits, Crits,
   ...
   <Image src="/startingout/songselect/count.png" className="w-100"/>
4. **Profile:** If you gained Volforce, it will pop up at the bottom next to your
   ...
   not mean 2nd most).
   <Image src="/startingout/songselect/profile-after.png" className="w-110"/>
5. **Spread of Accuracy:** Shows you details about how late or early you were. For example, this screenshow shows I hit 4 nears early and 10 nears late. Generally you want this to be as even as possible, but depending
   on a lot of factors, it might sway one side or the other.
   <Image src="/startingout/songselect/spread.png" className="w-100"/>
6. **Blaster gauge:** Shows you your current blaster gauge percentage. If you are at
   ...
   <Image src="/startingout/songselect/blaster.png" className="w-100"/>

Note that this was a screenshot from Konasute, so things will look slightly different if you are at the arcade. ../../../components/Media

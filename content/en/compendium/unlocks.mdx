...
To access the first 3 songs, you have to play a chart on your first track that
corresponds with the [radar](/compendium/radar) of the song to fill the gauge at the bottom. For
example, if you want to play the Sword song, the chart you pick on your first
track must have a [radar](/compendium/radar) of `One-hand` or `Peak` to fill the gauge. 
...
chart. There are different Ranks of difficulty that represent how hard the gauge

...
corresponding [Radar](/compendium/effect-radar) of the chart you want to unlock. There are 3 types of bars you can fill up the gauge with
- Tricky and Notes
- Hand-trip and Tsumami
- One-hand and Peak

Upon clearing a chart with MAXXIVE (or if you have Blaster Pass), your `VARIANT BAR` will fill up with the corresponding radar. So, if you played a chart with `Notes` as its highest, it will fill up with the Tricky and Notes bar.

Each type of bar has a song corresponding to it. So, for example the first Variant Gate folder, if you were to fill the bar with `One-hand` or `Peak`, you would get **Who then no 灯**
...
\* May not be fully accurate, guesses based on how blaster normally scales.
<div className="mt-2 text-center">
...
You can overfill your variant gauge up to 500% to play charts on a lower starting rank. You have to fill the gauge to 200% before you can try playing on a lower rank.

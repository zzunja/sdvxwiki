...
To access the 20, you have to clear all the charts of the previous three charts.
Upon clearing your chart, you will be put straight into the 20. You will be
locked to the max difficulty of `Rank V`. 

If you fail, you will have to redo clearing all the charts again to try again. You
will be able to challenge it at `RANK IV` but not any lower.

You can overfill your varaint gauge up to 500% to play charts on a lower starting rank. You have to fill the gauge to 200% before you can try playing on a lower rank.

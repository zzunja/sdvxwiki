...
Jiggle physics on navs are also disabled/toned down. 
...
<div className="flex items-center justify-center">
  ![chartcensor](/compendium/miscellaneous/censorjacket.webp)
</div>
...
As of 2025/07/14, All U Region cabs cannot use [MAXXIVE
rate](/compendium/gauge-options#maxxive-rate) on a Standard

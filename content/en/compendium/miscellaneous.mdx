...
- [Censorship](#censorship)
    - [Korea Censorship](#korean-censorship)
    - [US Censorship](#us-censorship)
- [Youtuber to watch](#youtubers-to-watch)
- [Resources](#resources)
## Censorship
...
#### Other Differences
U Region cabs, like all other regions besides Japan, can't use paseli. This means that credits is the main way to play at arcades. 

As of 2025/07/14, All U Region cabs have the old EX-Track system of filling up
the bar to get the EX-Track. Also, [MAXXIVE
rate](/compendium/gauge-options#maxxive-rate) is not available on a Standard
Start. Only [Blaster](/compendium/game-modes#blaster-start) or [Premium](/compendium/game-modes#premium-time) Start.

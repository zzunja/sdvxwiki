...
Konami rate limits download speed which can make the install for the game much longer. If you would like to avoid most of this rate limit, follow the instructions below, otherwise use [the official launcher instructions](#official).

Download this file [here](https://drive.google.com/file/d/1o6R0uw0bxywoX3EJ9Y5ZUj-xTdY5qeKT/view) and move it to `C:/Games/`. This is the base version of the game that is the same as if you downloaded it from the installer. 

You can now open the game. Using [this site](https://p.eagate.573.jp/game/konasteapp/API/login/login.html?game_id=sdvx) you can open the launcher. You have to navigate to this website to open the game, so it might be a good idea to keep it bookmarked.
...
Head to [Finishing the install](#finishing-the-install) to continue.

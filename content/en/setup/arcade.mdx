...
There is also [Vmsearch](https://www.vmsearch.net/) to find Valkyrie Machines.

![Zenius Search](/arcade/zenius.png)

On Zenius, your search should look like something like this. First check for `SOUND VOLTEX EXCEED GEAR (Valkyrie Model)` and if there is nothing select `SOUND VOLTEX EXCEED GEAR`.

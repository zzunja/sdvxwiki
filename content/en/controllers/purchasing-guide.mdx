...
<Image src="/controllers/faucetwos.webp" alt="faucetwo+" caption="FAUCETWO+ VW skin (left) and EG skin (right)" />
...
<Image src="/controllers/arcadecontroller.webp" alt="faucetwo+ arcade specs" className="w-128" />
...
<Image src="/controllers/yuancons.webp" alt="yuancons" caption="SDVX 12 (left) and SDVX LITE 3 (right)" />
...
<Image src="/controllers/minicontrollers.webp" alt="mini controllers" caption="Speedy Labs SDVX Pico v5 (left) and FAUCETWO Portable Edition (right)" />

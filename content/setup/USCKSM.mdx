...
You can either play Unnamed Sound Voltex Clone (USC) or K-Shoot Mania (KSM). KSM is much older and it's age shows. USC is more new and has a lot of features but considered to have a worse engine (mainly noticeable with lasers). I'd recommend playing USC as it is easier to use and has many more features.

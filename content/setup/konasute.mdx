...
# Setting up Konasute
## Table of Contents
1. [Intro](/setup/konasute#intro)
2. [Setup](/setup/konasute#setup)
    1. [Creating a Konami Account](/setup/konasute#creating-a-konami-account)
    2. [Downloading Konasute](/setup/konasute#downloading-konasute)
    3. [Options](/setup/konasute#options)
3. [Purchasing Konasute and Packs](/setup/konasute#purchasing-konasute-and-packs)
    1. [Purchasing Basic Course](/setup/konasute#purchasing-basic-course)
    2. [Song packs](/setup/konasute#song-packs)
4. [References](/setup/konasute#references)
## Intro
...
- **Monitor:** Which montior you want the game to launch on
...
- **DirectSound:** Highest delay. Doesn't take over audio driver.
- **WASAPI Exclusive:** Lower delay than WASAPI shared, about the same as ASIO. Takes over audio driver.
- **WASAPI Shared:** Higher delay than WASAPI exclusive. Doesn't take over audio driver
...
To get more songs, and specifically 20's, you will need to buy song packs. These
...
and sort by what song pack in the `Availability (PC)` dropdown, or head to

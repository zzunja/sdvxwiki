...
<Callout>
  ...
  that talks about setting up Konasute. While some small stuff has changed, this
...
<Callout>
  ...
  While its for DDR most stuff still applies here.
</Callout>
...
- Daily scheduled maintenance that prevents you from launching the game

If you want to know what songs are included with the basic course or what's in what song
pack, you can check [here](https://www.myshkin.io/sdvx/songlist).
Konami does like adding new songs to the basic course as well every couple of months.
...
- Windows options, from top to bottom:
  - Fullscreen
  - Fit window (borderless windowed)
  - Windowed

Most likely you want to keep Fullscreen "フルスクリーン"
...
If you are using a FauceTwo or YuanCon, you should not touch this. It should work by default assuming you are in eAC mode (check your controller's manual to see how to change mods). If it doesn't press the "Reset to default" button.
...
[Here](https://github.com/SakifX9/Rhythm-Game-Optimisations/blob/main/Voicemeeter/How%20to%20setup%20Voicemeeter%20for%20Rhythm%20Games.md) is a good guide for setting up ASIO and getting the best latency.
...
comes with around 688 default songs with more being added every occasionally. You can check out the default song list [here](https://www.myshkin.io/sdvx/songlist)
...
or roughly $10.52 USD at the time of writing. Select how much Paseli you want and click
...
To get more songs, and specifically 20's, you will need to buy song packs. These can be pretty expensive and it is recommended to wait for a sale where most of the packs go 50% off. These sales can happen anytime and usually last for about a week or so. To know when a sale happens, you can either follow:

...
# Arcade
## Table of Contents
- [Finding an SDVX Cabinet](/setup/arcade#finding-an-sdvx-cabinet)
    - [For US Players](/setup/arcade#for-us-players)
    - [For everyone else](/setup/arcade#for-everyone-else)
- [Playing in an arcade for the first time](/setup/arcade#playing-in-an-arcade-for-the-first-time)
    - [Get an e-amusement card](/setup/arcade#get-an-e-amusement-card)
- [Creating an account](/setup/arcade#creating-an-account)
- [Creating a profile and playing your first credit](/setup/arcade#creating-a-profile-and-playing-your-first-credit)

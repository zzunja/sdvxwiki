...
Controllers are expensive! If you are just starting, It is recommended trying the game either at an arcade or with your keyboard before you go all in with a controller. Make sure you like the game first!
...
The Faucetwo tends to be more popular option because of it's better knobs and more customization options. 

YuanCon, and specifically the YuanCon LITE can be much cheaper than a Faucetwo.
...
- **Switch:** 
  - **Honeywell:** Cheapest option. Heavily recommend agaisnt. Also known as Chinese switches.
  - **Omron:** Middle ground between Honeywell and OBSA. These are the recommend. 
...
- **Spring and Switch weight:** There are a lot of options that you can choose.
Arcade is 20/100 and what is the most popular. Some people also enjoy 40/100 as
the buttons rebounds a bit faster. If you are using DJDAO, you won't be given
the option to get 20g springs. In that case, 60/100 is also good but note it
will be a bit heavier. Spring and switch weight are heavily preference, some
...
unit. These uses physical dampers that you have to replace every once in a while. These feel about the same as the GAMO2 Damping knob unit.


The general consistence is that switches make up most of the feeling for controllers. 
...
This is overkill for most people especially if you are just starting. At the

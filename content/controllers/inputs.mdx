...
These are the best controllers and are considered "necessary" to start really playing the game. While you can play on a keyboard or other devices, it's considered a very different game.
...
Button - You can either choose DJDAO or Sanwa. Sanwa are more expensive but do feel better. The difference is noticeable but much more of a luxury. 
...
- Honeywell -  These are bad, it is recommended to not get Honeywell at the minimum. 
...
Knob unit type - You can either choose the VM-style knobs or the GAMO2 damping knob unit. The GAMO2 damping knob unit feels very good and should be good for everyone. The VM knobs are mainly luxury and not needed at all.

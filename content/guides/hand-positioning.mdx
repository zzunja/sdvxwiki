...
<Video src="/guides/hand-positioning/turning_knobs_2.mp4" types="video/mp4" size="max-w-sm"/>
...
<Video src="/guides/hand-positioning/thumbing.mp4" types="video/mp4" size = "max-w-2xl" />
...
In Japanese, "kuso" (くそ / 糞) literally means "shit". Kuso techniques refer to unorthodox ways to play charts, usually for entertainment. Oftentimes, they complicate more than trivialize patterns, though this guide focuses more on the latter.

...
- [Techniques](#techniques)
  ...
  - [Jacks](#jacks)
    - [Alternating Fingers](#alternating-fingers)
...
<div className="flex flex-row gap-x-4">
  ...
  <Video src="/guides/hand-positioning/chord_jack.mp4" type="video/mp4" />
</div>
...
<div className="flex flex-row gap-x-4">
  ...
  <Video src="/guides/hand-positioning/chord_stairs.mp4" type="video/mp4" />
</div>
...
<Video src="/guides/hand-positioning/chord_stairs_static.mp4" type="video/mp4" />
...
<div className="flex flex-row gap-x-4">
  ...
  <Video src="/guides/hand-positioning/hamburgers.mp4" type="video/mp4" />
</div>

### Hand-blading

<Video src="/guides/hand-positioning/handblading.mp4" type="video/mp4" />
...
<div className="flex flex-row gap-x-4">
  ...
  <Video src="/guides/hand-positioning/jacks.mp4" type="video/mp4" />
</div>
...
<Video src="/guides/hand-positioning/jacks_one_hand.mp4" type="video/mp4" />
...
<Video src="/guides/hand-positioning/jacks_static.mp4" type="video/mp4" />
...
<Video src="/guides/hand-positioning/turning_knobs.mp4" type="video/mp4" />
...
<Video src="/guides/hand-positioning/turning_knobs_2.mp4" type="video/mp4" />
...
<Video src="/guides/hand-positioning/turning_knobs_poor.mp4" type="video/mp4" />
...
<div className="flex flex-row gap-x-4">
  ...
  <Video src="/guides/hand-positioning/double_fx_bt_chords.mp4" type="video/mp4" />
</div>
...
<div className="flex flex-row gap-x-4">
  ...
  <Video src="/guides/hand-positioning/double_fx_bt_trill.mp4" type="video/mp4" />
</div>
...
<div className="flex flex-row gap-x-4">
  ...
  <Video src="/guides/hand-positioning/fast_chord_jacks.mp4" type="video/mp4" />
</div>
...
<div className="flex flex-row gap-x-4">
  ...
  <Video src="/guides/hand-positioning/fast_triple_stairs.mp4" type="video/mp4" />
</div>

<div className="flex flex-row gap-x-4">
  <Image src="/guides/hand-positioning/ex_fast_stairs.png" alt="fast stairs example" />
  <Video src="/guides/hand-positioning/fast_stairs.mp4" type="video/mp4" />
</div>

<div className="flex flex-row gap-x-4">
  <Image src="/guides/hand-positioning/ex_fast_stairs_full.png" alt="fast stairs full example" />
  <Video src="/guides/hand-positioning/fast_stairs_full.mp4" type="video/mp4" />
</div>
...
<div className="flex flex-row gap-x-4">
  ...
  <Video src="/guides/hand-positioning/fast_trills.mp4" type="video/mp4" />
</div>
...
<Video src="/guides/hand-positioning/thumbing.mp4" type="video/mp4" />

...
To change Hi-Speed, hold BT-D and press up and down arrows if you are on song select. In game just press the arrows. If you are stuck on multipler, press left or right arrow keys to select the number. The number is out of 1000, but 1000 is same as 10.00 lane speed. (900 is 9.0, 850 is 8.5 etc.)

### Skins
There is also KSM skins, but they are generally harder to find. A lot of them are really old and some are in japanese only. Some download links are also lost to time. You can maybe fine some [here](https://www.reddit.com/r/kshootmania/wiki/skins/). 

To install a skin, backup your **imgs** and **se** folder. This is your default skin. I would recommend putting this in a folder if something happens. Alternativly you can also just redownload KSM to get it back. After this, extrat the skin into the root of your folder and replace anything that needs to be replaced. This will install the skin for you 
...
After downloading a chart, place the folder in the songs folder. For example, /USC/songs is where I would put my songs. Make sure they are extracted and in their own folder.
